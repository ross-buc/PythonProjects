...
product = {
    "Dell Laptop": {"Amazon_Url": "https://www.amazon.com.au/XPS7390-InfinityEdge-Touchscreen-i5-10210U-Windows/dp/B07ZSFXPZX",
                    "Target_Price": 3000}
}
...
if int(amazon_current_price_format) < int(product["Dell Laptop"]["Target_Price"]):
    print(f"The {list(product)[0]} is now ${amazon_current_price_format}. Sending email details...")
    send_email(list(product)[0], amazon_current_price_format, product["Dell Laptop"]["Amazon_Url"])
